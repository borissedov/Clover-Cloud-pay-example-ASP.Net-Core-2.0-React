            ...
            <div className="home_menu">
                <Link to="/register">
                    <div className="home_button">
                        ...
                        <img className="home_icon" src={"images/clover/new_order.png"}/>
                    </div>
                </Link>
                <div className="home_button">
                    <div className="home_title">New Tab (PreAuth)</div>
                    <img className="home_icon" src={"images/clover/new_tab.png"}  onClick={this.preAuth}/>
                </div>
                <Link to="/orders">
                    <div className="home_button">
                        <div className="home_title">View Orders</div>
                        <img className="home_icon" src={"images/clover/orders.png"}/>
                    </div>
                </Link>
                <Link to="/vault-card">
                    <div className="home_button">
                        <div className="home_title">Customers (Vault Card)</div>
                        <img className="home_icon" src={"images/clover/card.png"}/>
                    </div>
                </Link>
                <Link to="/refunds">
                    <div className="home_button">
                        <div className="home_title">Manual Refunds / Credit</div>
                        <img className="home_icon" src={"images/clover/refund.png"}/>
                    </div>
                </Link>
                <Link to="/transactions">
                    <div className="home_button">
                        <div className="home_title">Transactions</div>
                        <img className="home_icon" src={"images/clover/transactions.png"}/>
                    </div>
                </Link>
                <Link to="/custom-activities">
                    <div className="home_button">
                        <div className="home_title">Custom Activities</div>
                        <img className="home_icon" src={"images/clover/custom_activity.png"}/>
                    </div>
                </Link>
                <Link to="/device">
                    <div className="home_button">
                        <div className="home_title">Device</div>
                        <img className="home_icon" src={"images/clover/device.png"}/>
                    </div>
                </Link>
                <Link to="/recovery-options">
                    <div className="home_button">
                        <div className="home_title">Recovery Options</div>
                        <img className="home_icon" src={"images/clover/recovery.png"}/>
                    </div>
                </Link>
            </div>
        );
